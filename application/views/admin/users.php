...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="<?=base_url('admin')?>" class="logo" style="background-color: #ffffff">
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <?php } ?>
                <p>
                  <?=$this->session->userdata('name')?> - Web Gudang GESITS
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?= base_url('admin/form_stokbarang')?>"><i class="fa fa-circle-o"></i> Tambah Data Stok Barang</a></li>
            <li><a href="<?= base_url('admin/form_satuan')?>"><i class="fa fa-circle-o"></i> Tambah Data Satuan Barang</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?=base_url('admin/users')?>" class="active">Tabel Users</a></li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><i class="fa fa-fw fa-users" aria-hidden="true"></i> Tabel Users</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright PT WIKA Industri Manufaktur &copy; <?=date('Y')?></strong>
