        ...
        <div class="col-md-12">
          ...
          <div class="box box-success" style="width:90%;">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-pencil-square-o" aria-hidden="true" style="margin-right:5px"></i>Add Purchase Order</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <div class="container">
            <form action="<?=base_url('admin/proses_tambah_dataDelv_input')?>" role="form" method="post">
              ...
              <?php foreach ($data_part_input as $d) { ?>
                  <div class="form-group">
                    ...
                    <input autocomplete="off" type="text" name="id_pengiriman" required style="margin-left:49px;width:20%;display:inline;" class="form-control" readonly="true"
                  ...
                  <div class="form-group">
                    ...
                    <input autocomplete="off" type="text" name="nomor_po" required style="margin-left:18px;width:20%;display:inline;" class="form-control" id="nomor_po" placeholder="Nomor Purchase Order">
                  </div>
                  <div class="form-group">
                    <label for="nomor_part" style="margin-left:220px;display:inline;">Nomor Part</label>
                    <input type="text" name="nomor_part" style="margin-left:76px;margin-right:35px;width:20%;display:inline;"  readonly="true" class="form-control" id="nomor_part" value="<?= $d->nomor_part ?>">
                  </div>
                  <div class="form-group">
                    <label for="nama_part" style="margin-left:220px;display:inline;">Nama Part</label>
                    <input type="text" name="nama_part" style="margin-left:82px;margin-right:35px;width:20%;display:inline;"  readonly="true" class="form-control" id="nama_part" value="<?= $d->nama_part ?>">
                  </div>
                  <div class="form-group">
                    <label for="satuan" style="margin-left:220px;display:inline;">Satuan</label>
                    <input type="text" name="satuan" style="margin-left:76px;margin-right:35px;width:20%;display:inline;"  readonly="true" class="form-control" id="satuan" value="<?= $d->satuan ?>">
                  </div>
                  <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input autocomplete="off" type="harga" name="harga" required style="margin-left:97px;margin-right:35px;width:20%;display:inline;" class="form-control" id="harga" placeholder="Harga Part">
                </div>
              ...
              <div class="box-footer" style="width:89%;">
                ...
                <a type="button" class="btn btn-primary" style="width:20%;margin-right:29%" href="<?=base_url('admin/tabel_datadelv')?>" name="btn_listbarang"><i class="fa fa-table" aria-hidden="true"></i> Daftar Delivery Part</a>
