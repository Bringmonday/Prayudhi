      ...
      <li class="header" style="background-color: #B1B5BA;">HOME</li>
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu" style="background-color: #DFE2E6;">
            <li class="active"><a onmouseover="this.style.backgroundColor='#B1B5BA';" onmouseout="this.style.backgroundColor='#DFE2E6';" style="color: black;font-weight: bold;"  href="<?= base_url('admin/form_datapart')?>"><i class="fa fa-square-o" style="font-weight: bold;"></i> Input Data Part</a></li>
  ...
  <style> a:hover {background-color: #B1B5BA;}</style>
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Input Data Part</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-success" style="width:90%;">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-pencil-square-o" aria-hidden="true" style="margin-right:5px"></i>Input Data Part</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <div class="container">
            <form action="<?=base_url('admin/proses_tambah_dataPart_insert')?>" role="form" method="post">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <select class="form-control" name="nama_customer" id="customer" required style="margin-left: 70px; margin-right: 35px; width: 20%; display: inline;">
                  ...
                  <input autocomplete="off" type="text" name="nomor_part" required style="margin-left:57px;width:20%;display:inline;" class="form-control" id="nomor_part" placeholder="Nomor Part">
                </div>
                <div class="form-group" style="display:inline">
                  <label for="nama_part" style="margin-left:220px;display:inline;">Nama Part</label>
                  <input autocomplete="off" type="text" name="nama_part" required style="margin-left:63px;margin-right:35px;width:20%;display:inline;" class="form-control" id="nama_part" placeholder="Nama Part">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input autocomplete="off" type="hidden" name="id_part" required style="margin-left:86px;width:20%;display:inline;" class="form-control" readonly="true"
              ...
              <div class="box-footer" style="width:89%;">
                ...
                <a type="button" class="btn btn-primary" style="width:21  %;margin-right:29%" href="<?=base_url('admin/tabel_datapart')?>" name="btn_listbarang"><i class="fa fa-table" aria-hidden="true"></i> Lihat Daftar Part Customer</a>
