      ...
      <li class="header" style="background-color: #B1B5BA;">HOME</li>
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu" style="background-color: #DFE2E6;">
            <li><a onmouseover="this.style.backgroundColor='#B1B5BA';" onmouseout="this.style.backgroundColor='#DFE2E6';" style="color: black;"  href="<?= base_url('admin/form_datapart')?>"><i class="fa fa-square-o"></i> Input Data Customer</a></li>
            <li class="active"><a onmouseover="this.style.backgroundColor='#B1B5BA';" onmouseout="this.style.backgroundColor='#DFE2E6';" style="color: black;font-weight: bold;" href="<?= base_url('admin/form_customer')?>"><i class="fa fa-square-o" style="font-weight: bold;"></i> Input Data Customer</a></li>
          </ul>
        </li>
  ...
  <style> a:hover {background-color: #B1B5BA;}</style>
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="form_datapart">Form</a></li>
          ...
          <div class="container">
            ...
            <div class="box box-success" style="width:90%;">
              <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-pencil-square-o" aria-hidden="true" style="margin-right:5px"></i>Data Customer</h3>
              </div>
              <!-- /.box-header -->
              <!-- form start -->
              <div class="container">
                  <form action="<?=base_url('admin/proses_tambah_dataCust_insert')?>" role="form" method="post">
                      <!-- Form Anda -->
                      <!-- ... -->
                      <div><label></label></div>
                      <div class="form-group" style="display:inline">
                          <label for="nama_customer" style="margin-left:220px;display:inline;">Nama Customer</label>
                          <input autocomplete="off" type="text" name="nama_customer" required style="margin-left:63px;margin-right:35px;width:20%;display:inline;" class="form-control" id="nama_customer" placeholder="Nama Customer">
                      </div>
                      ...
                      <div class="form-group">
                          <a type="button" class="btn btn-default" style="width:10%;margin-right:26%;margin-left:1%" onclick="history.back(-1)" name="btn_kembali"><i class="fa fa-arrow-left" aria-hidden="true"></i> Kembali</a>
                          <button type="submit" style="width:10%;margin-left:39%" class="btn btn-success"><i class="fa fa-check" aria-hidden="true"></i> Submit</button>
                      </div>
                      <!-- /.box-body -->
                      
                      <div class="box-footer" style="width:88%;">
                      </div>
                  </form>
                            ...
                            <?php if (is_array($list_data)) { ?>
                                <?php foreach ($list_data as $dd): ?>
                                    <tr>
                                        ...
                                        <td>
                                          <!-- Tambahkan tombol Delete dengan link ke controller -->
                                          <a href="<?= base_url('admin/delete_customer/' . $dd->id_customer) ?>" class="btn btn-danger">
