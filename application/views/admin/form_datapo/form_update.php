  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?=base_url('admin/tabel_datapo')?>">Tables</a></li>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-success" style="width:90%;">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-share-square-o" aria-hidden="true" style="margin-right:5px"></i> Update Data Purchase Order</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <div class="container">
            <form action="<?=base_url('admin/proses_tambah_dataPo_update')?>" role="form" method="post">
              ...
              <div class="box-body">
              <?php foreach($data_po_update as $d){ ?>
                ...
                <div class="form-group">
                      ...
                      <select class="form-control" name="bulan" id="bulan" required style="margin-left: 113px; margin-right: 35px; width: 20%; display: inline;">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="jumlah" required style="margin-left:102px;margin-right:35px;width:20%;display:inline;" class="form-control" id="jumlah" value="<?=$d->jumlah?>">
                </div>
                <div class="form-group">
                  <label for="harga" style="margin-left:220px;display:inline;">Harga</label>
                  <input type="text" name="harga" required style="margin-left:112px;margin-right:35px;width:20%;display:inline;" class="form-control" id="harga" value="<?=$d->harga?>">
                </div>
                <div class="form-group" style="display:inline">
                  <label for="keterangan" style="margin-left:220px;display:inline;">Keterangan</label>
                  <input type="text" name="keterangan" required style="margin-left:78px;margin-right:35px;width:20%;display:inline;" class="form-control" id="keterangan" value="<?=$d->keterangan?>">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="hidden" name="id_po" style="margin-left:36px;width:20%;display:inline;" class="form-control" readonly="readonly" value="<?=$d->id_po?>">
                </div>
                <?php } ?>
              <!-- /.box-body -->

              <div class="box-footer" style="width:89%;">
                <a type="button" class="btn btn-default" style="width:10%" href="<?=base_url('admin/cari_po')?>" name="btn_kembali"><i class="fa fa-arrow-left" aria-hidden="true"></i> Kembali</a>
