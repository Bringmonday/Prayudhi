    ...
    <section class="sidebar">
      ...
      <li class="header" style="background-color: #B1B5BA;">HOME</li>
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu" style="background-color: #DFE2E6;">
            <li class="active"><a onmouseover="this.style.backgroundColor='#B1B5BA';" onmouseout="this.style.backgroundColor='#DFE2E6';" style="color: black" href="<?= base_url('admin/tabel_datapart')?>"><i class="fa fa-square-o"></i> Data Part Customer</a></li>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-success" style="width:90%;">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-pencil-square-o" aria-hidden="true" style="margin-right:5px"></i>Add Data Purchase Order</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <div class="container">
            <form action="<?=base_url('admin/proses_tambah_dataPO_input')?>" role="form" method="post">
              ...
              <div class="box-body">
              <?php foreach ($data_po_input as $d) { ?>
                  ...
                  <select class="form-control" name="bulan" id="bulan" required style="margin-left: 113px; margin-right: 35px; width: 20%; display: inline;" readonly>
                      <option value="" disabled selected>Pilih Bulan</option> 
                      <?php foreach($list_bulan as $s){ ?>
                      <option value="<?=$s->bulan?>"><?=$s->bulan?></option>
                      <?php } ?>
                  </select>
                </div>
                <div class="form-group">
                    <label for="tanggal_masuk" style="margin-left:220px;display:inline;">Tanggal Input</label>
                    <input autocomplete="off" type="datetime-local" name="tanggal_masuk" required style="margin-left:62px;width:20%;display:inline;" class="form-control" id="tanggal_masuk">
                  </div>
                  <div class="form-group">
                  ...
                  <script>
                      ...
                      document.getElementById('data_po').addEventListener('submit', function (event) {
                          if (!validateForm()) {
                  ...
                  <div class="form-group">
                    <label for="jumlah" style="margin-left:220px;display:inline;">Qty Purchase Oder</label>
                    <input type="text" name="jumlah" required style="margin-left:32px;margin-right:35px;width:20%;display:inline;" class="form-control" id="jumlah" placeholder="Jumlah Purchase Order">
                  </div>
                  <div class="form-group">
                    <label for="harga" style="margin-left:220px;display:inline;">Harga</label>
                    <input type="text" name="harga" style="margin-left:111px;margin-right:35px;width:20%;display:inline;" class="form-control" id="harga"  readonly="true" value="<?= $d->harga ?>">
                  </div>
                  <div class="form-group" style="display:inline">
                    <label for="keterangan" style="margin-left:221px;display:inline;">Keterangan</label>
                    <input type="text" name="keterangan" required style="margin-left:76px;margin-right:35px;width:20%;display:inline;" class="form-control" id="keterangan" placeholder="Keterangan">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input autocomplete="off" type="hidden" name="id_po" required style="margin-left:36px;width:20%;display:inline;" class="form-control" readonly="true"
              ...
              <div class="box-footer" style="width:89%;">
                ...
                <a type="button" class="" style="width:20%;margin-right:52%" href="<?=base_url('admin/tabel_datapo')?>" name="btn_po"><i class="" aria-hidden="true"></i></a>
