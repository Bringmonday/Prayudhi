      ...
      <li class="header" style="background-color: #B1B5BA;">HOME</li>
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu" style="background-color: #DFE2E6;">
            ...
            <li  class="active"><a  onmouseover="this.style.backgroundColor='#B1B5BA';" onmouseout="this.style.backgroundColor='#DFE2E6';" style="color: black;font-weight: bold;" href="<?= base_url('admin/tabel_akumulasi')?>"><i class="fa fa-square-o" style="font-weight: bold;"></i> Akumulasi Delivery Part</a></li>
          </ul>
        </li>
      </ul>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box box-success">
            ...
            <div class="box-body">
              ...
              <?php } ?>
              <a href="<?= base_url('User/downloadPDF') ?>" style="margin-bottom:10px;" type="button" class="btn btn-primary" name="tambah_data" style="display:inline"><i class="fa fa-external-link" aria-hidden="true" style="margin-right:2px;"></i> Unduh Data</a>
