        ...
        <div class="col-xs-12">
          ...
          <div class="box box-success">
            <div class="box-header">
              <h3 class="box-title"><i class="fa fa-table" aria-hidden="true" style="margin-right:5px"></i>Data Part Customer</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <?php } ?>
              <a href="<?=base_url('admin/form_datapart')?>" style="margin-bottom:10px;" type="button" class="btn btn-primary" name="tambah_data" style="display:inline"><i class="fa fa-external-link" aria-hidden="true" style="margin-right:2px;"></i> Tambah Data Part</a>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <?php foreach($list_data as $dd): ?>
                    ...
                    <td><?=$dd->nama_part?></td>
                    <td align="center">
                        <a type="button" title="Update" class="btn btn-info"  href="<?=base_url('admin/update_datapart/'.$dd->id_part)?>" name="btn_update" style="margin-right:5px;"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                        <a type="button" title="Delete" class="btn btn-danger btn-delete"  href="<?=base_url('admin/delete_datapart/'.$dd->id_part)?>" name="btn_delete" style="margin:1px;"><i class="fa fa-trash" aria-hidden="true"></i></a>
                        <a type="button" title="Input Data PO" class="btn btn-warning btn-tambah"  href="<?=base_url('admin/input_datapart/'.$dd->id_part)?>" name="btn_tambah" style="margin:5px; background-color:orange;"><i class="fa fa-plus-square" aria-hidden="true"></i></a>
                    </td>
                </tr>
              <?php $no++; ?>
              <?php endforeach;?>
