        ...
        <div class="col-xs-12">
          ...
          <div class="box box-success">
            <div class="box-header">
              <h3 class="box-title"><i class="fa fa-table" aria-hidden="true" style="margin-right:5px"></i>Data Purchase Order</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <?php } ?>
              <a href="<?=base_url('admin/tabel_datapart')?>" style="margin-bottom:10px;" type="button" class="btn btn-primary" name="tambah_data" style="display:inline"><i class="fa fa-external-link" aria-hidden="true" style="margin-right:2px;"></i> Input Data Purchase Order</a>
              <a href="<?=base_url('admin/cari_po')?>" style="margin-bottom:10px;" type="button" class="btn btn-primary btn-search" name="btn_search" style="display:inline"><i class="fa fa-newspaper-o" aria-hidden="true" style="margin-right:5px;"></i>Detail Purchase Order</a>
