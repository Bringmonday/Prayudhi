      ...
      <li class="header" style="background-color: #B1B5BA;">HOME</li>
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu" style="background-color: #DFE2E6;">
            ...
            <li class="active"><a onmouseover="this.style.backgroundColor='#B1B5BA';" onmouseout="this.style.backgroundColor='#DFE2E6';" style="color: black;font-weight: bold"  href="<?= base_url('admin/tabel_datadelv')?>"><i class="fa fa-square-o" style="font-weight: bold;"></i> Data Actual Delivery</a></li>
        ...
        <div class="col-xs-12">
          ...
          <div class="box box-success">
            <div class="box-header">
              <h3 class="box-title"><i class="fa fa-table" aria-hidden="true" style="margin-right:5px"></i>Data Actual Delivery</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <?php } ?>
              <form  method="post" action="<?= base_url('admin/cari_pengiriman') ?>" style="display: flex;">
              ...
              <a type="button" class="btn btn-default" style="flex: 0; margin-left: 10px; margin-right: 10px; margin-top: 25px;  height:35px;"  href="<?=base_url('admin/tabel_datadelv')?>" name="btn_kembali"><i aria-hidden="true"></i> Reset</a>
            </form>
