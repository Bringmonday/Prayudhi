    ...
    <section class="content">
      ...
      <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-olive">
            ...
            <a href="<?=base_url('admin/tabel_datapo')?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          <!-- small box -->
          <div class="small-box bg-light-blue" style="width: 103%;">
            <div class="inner">
            <?php if(!empty($DeliveryPart)){ ?>
              <?php foreach($DeliveryPart as $d){ ?>
              <h3><?=$d->pengiriman?></h3>
              <?php } ?>
            <?php }else{ ?>
              <h3>0</h3>
            <?php } ?>
              <p>Akumulasi Delivery Part</p>
            </div>
            <div class="icon">
              <i class="ion ion-folder"></i>
            </div>
            <a href="<?=base_url('admin/tabel_akumulasi')?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
