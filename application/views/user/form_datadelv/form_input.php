        ...
        <div class="col-md-12">
          ...
          <div class="box box-success" style="width:90%;">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-pencil-square-o" aria-hidden="true" style="margin-right:5px"></i>Add Actual Delivery Part</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <div class="container">
            <form action="<?=base_url('user/proses_tambah_dataDelv_input')?>" id="data_delv" role="form" method="post">
              ...
              <div class="box-body">
              <?php foreach ($data_delv_input as $d) { ?>
                  <div class="form-group">
                    <label for="id_pengiriman" style="margin-left:220px;display:inline;">Id Delivery</label>
                    <input autocomplete="off" type="text" name="id_pengiriman" required style="margin-left:81px;width:20%;display:inline;" class="form-control" readonly="true"
                  ...
                  <div class="form-group">
                    ...
                    <input autocomplete="off" type="datetime-local" name="tanggal_masuk" required required style="margin-left:62px;width:20%;display:inline;" class="form-control" id="tanggal_masuk">
                  </div>
                  <div class="form-group">
                  <label for="bulan" style="margin-left: 218px; display: inline;">Bulan</label>
                      <select name="bulan" style="margin-left:113px; margin-right:20px; width:20%; display:inline;" class="form-control" id="bulan" required readonly ="">
                  ...
                  <div class="form-group" style="display:inline">
                    ...
                    <input type="text" name="pengiriman" required style="margin-left:76px;margin-right:35px;width:20%;display:inline;" class="form-control" id="pengiriman" placeholder="Pengiriman">
                  </div>
              ...
              <div class="box-footer" style="width:89%;">
                <a type="button" class="btn btn-default" style="width:10%;margin-right:26%" href="<?=base_url('user/cari_pengiriman')?>" name="btn_kembali"><i class="fa fa-arrow-left" aria-hidden="true"></i> Kembali</a>
                <a type="button" class="" style="width:20%;margin-right:52%" href="<?=base_url('user/tabel_datadelv')?>" name="btn_listbarang"><i class="" aria-hidden="true"></i></a>
