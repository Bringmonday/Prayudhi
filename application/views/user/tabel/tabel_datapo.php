      ...
      <li class="header" style="background-color: #B1B5BA;">HOME</li>
        ...
        <li class="treeview active">
          ...
          <li><a  onmouseover="this.style.backgroundColor='#B1B5BA';" onmouseout="this.style.backgroundColor='#DFE2E6';" style="color: black;" href="<?= base_url('user/tabel_datastok')?>"><i class="fa fa-square-o"></i> Data Actual Stok Part</a></li>
            ...
            <li class="active"><a onmouseover="this.style.backgroundColor='#B1B5BA';" onmouseout="this.style.backgroundColor='#DFE2E6';" style="color: black;font-weight: bold;"  href="<?= base_url('user/tabel_datapo')?>"><i class="fa fa-square-o" style="font-weight: bold;"></i> Data Purchase Order</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?=base_url('user/tabel_datapo')?>">Tables</a></li>
        ...
        <div class="col-xs-12">
          ...
          <div class="box box-success">
            ...
            <div class="box-body">
              ...
              <form  method="post" action="<?= base_url('user/cari_po') ?>" style="display: flex;">
              ...
              <a type="button" class="btn btn-default" style="flex: 0; margin-left: 10px; margin-right: 10px; margin-top: 25px;  height:35px;"  href="<?=base_url('user/tabel_datapo')?>" name="btn_kembali"><i aria-hidden="true"></i> Reset</a>
            </form>
