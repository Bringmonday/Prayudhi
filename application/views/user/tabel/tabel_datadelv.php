        ...
        <div class="col-xs-12">
          ...
          <div class="box box-success">
            ...
            <div class="box-body">
              ...
              <?php } ?>
              <a href="<?=base_url('user/form_datadelv/form_input')?>" style="margin-bottom:10px;" type="button" class="btn btn-primary" name="tambah_data" style="display:inline"><i class="fa fa-external-link" aria-hidden="true" style="margin-right:2px;"></i> Input Data Delivery Part</a>
              <a href="<?=base_url('user/cari_pengiriman')?>" style="margin-bottom:10px;" type="button" class="btn btn-primary btn-search" name="btn_search" style="display:inline"><i class="fa fa-newspaper-o" aria-hidden="true" style="margin-right:5px;"></i>Detail Delivery</a>
