      ...
      <li class="header" style="background-color: #B1B5BA;">HOME</li>
        ...
        <li class="treeview" style="background-color: #DFE2E6;">
          ...
          <ul class="treeview-menu" style="background-color: #DFE2E6;">
            ...
            <li class="active"><a onmouseover="this.style.backgroundColor='#B1B5BA';" onmouseout="this.style.backgroundColor='#DFE2E6';" style="color: black"  href="<?= base_url('user/form_datadelv')?>"><i class="fa fa-square-o"></i>Input Data Purchase Order</a></li>
          </ul>
        </li>
        ...
        <div class="col-xs-12">
          ...
          <div class="box box-success">
            <div class="box-header">
              <h3 class="box-title"><i class="fa fa-table" aria-hidden="true" style="margin-right:5px"></i>Data Actual Stok Part</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <?php } ?>
              <a href="<?=base_url('user/form_datastok')?>" style="margin-bottom:10px;" type="button" class="btn btn-primary" name="tambah_data" style="display:inline"><i class="fa fa-external-link" aria-hidden="true" style="margin-right:2px;"></i> Tambah Actual Data Stok</a>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <?php foreach($list_data as $dd): ?>
                    ...
                    <td><?=$dd->data_stok?></td>
                    <td align="center">
                        <a type="button" title="Update" class="btn btn-info"  href="<?=base_url('user/update_datastok/'.$dd->id_data_stok)?>" name="btn_update" style="margin-right:5px;"><i class="fa fa-pencil" aria-hidden="true"></i></a> <a type="button" title="Delete" class="btn btn-danger btn-delete"  href="<?=base_url('user/delete_datastok/'.$dd->id_data_stok)?>" name="btn_delete" style="margin:1px;"><i class="fa fa-trash" aria-hidden="true"></i></a>
                    </td>
                </tr>
              <?php $no++; ?>
              <?php endforeach;?>
