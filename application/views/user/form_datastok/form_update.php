    ...
    <section class="sidebar">
      ...
      <li class="header" style="background-color: #B1B5BA;">HOME</li>
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu" style="background-color: #DFE2E6;">
            <li class="active"><a onmouseover="this.style.backgroundColor='#B1B5BA';" onmouseout="this.style.backgroundColor='#DFE2E6';" style="color: black;font-weight: bold;" href="<?= base_url('user/tabel_datastok')?>"><i class="fa fa-square-o" style="font-weight: bold;"></i> Data Actual Stok Part</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?=base_url('user/tabel_datastok')?>">Tables</a></li>
        <li class="active">Data Actual Stok Part</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-success" style="width:90%;">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-share-square-o" aria-hidden="true" style="margin-right:5px"></i> Update Data Stok</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <div class="container">
            <form action="<?=base_url('user/proses_tambah_dataStok_update')?>" role="form" method="post">
              ...
              <div class="box-body">
                ...
                <?php foreach($data_stok_update as $d){ ?>
                  <label for="id_data_stok" style="margin-left:220px;display:inline;">Id Data Stok</label>
                  <input type="text" name="id_data_stok" style="margin-left:73px;width:20%;display:inline;" class="form-control" readonly="readonly" value="<?=$d->id_data_stok?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input autocomplete="off" type="text" name="nama_customer" style="margin-left:49px;width:20%;display:inline;" class="form-control" readonly="true" id="nomor_customer" value="<?=$d->nama_customer?>">
                </div>
                <div class="form-group">
                  <label for="nomor_part"style="margin-left:220px;display:inline;">Nomor Part</label>
                  <input autocomplete="off" type="text" name="nomor_part" style="margin-left:76px;width:20%;display:inline;" class="form-control" readonly="true" id="nomor_part" value="<?=$d->nomor_part?>">
                </div>
                <div class="form-group">
                  <label for="nama_part" style="margin-left:220px;display:inline;">Nama Part</label>
                  <input type="text" name="nama_part" style="margin-left:82px;margin-right:35px;width:20%;display:inline;" class="form-control" id="nama_part" readonly="true" value="<?=$d->nama_part?>">
                </div>
                <div class="form-group" style="display:inline">
                  <label for="data_stok" style="margin-left:220px;display:inline;">Data Stok</label>
                  <input type="text" name="data_stok" required style="margin-left:89px;margin-right:35px;width:20%;display:inline;" class="form-control" id="data_stok" value="<?=$d->data_stok?>">
                </div>
