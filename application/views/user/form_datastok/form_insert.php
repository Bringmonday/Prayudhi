...
<div class="wrapper">
      ...
      <li class="header" style="background-color: #B1B5BA;">HOME</li>
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu" style="background-color: #DFE2E6;">
            <li class="active"><a onmouseover="this.style.backgroundColor='#B1B5BA';" onmouseout="this.style.backgroundColor='#DFE2E6';" style="color: black;font-weight: bold;"  href="<?= base_url('user/form_datastok')?>"><i class="fa fa-square-o" style="font-weight: bold;"></i> Input Actual Data Stok</a></li>
            <li class="active"><a onmouseover="this.style.backgroundColor='#B1B5BA';" onmouseout="this.style.backgroundColor='#DFE2E6';" style="color: black"  href="<?= base_url('user/form_datadelv')?>"><i class="fa fa-square-o"></i> Input Actual Delivery Part</a></li>
          </ul>
        </li>
  ...
  <style> a:hover {background-color: #B1B5BA;}</style>
    ...
    <section class="content-header">
      <h1>
          Input Actual Data Stok
      </h1>
      <ol class="breadcrumb">
        <li><a href="index"><i class="fa fa-bookmark"></i>Home</a></li>
        <li><a href="form_datastok">Forms</a></li>
        <li class="active">Input Actual Data Stok</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-success" style="width:90%;">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-pencil-square-o" aria-hidden="true" style="margin-right:5px"></i>Input Actual Data Stok</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <div class="container">
            <form action="<?=base_url('user/proses_tambah_dataStok_insert')?>" role="form" method="post">
              ...
              <div class="form-group">
                    ...
                    <input autocomplete="off" type="text" name="nama_customer" id="nama_customer_input" required style="margin-left: 71px; width: 20%; display: inline;" class="form-control" placeholder="Nama Customer" readonly="true">
                </div>
                <div class="form-group">
                    <label for="tanggal_masuk" style="margin-left:220px;display:inline;">Tanggal Input</label>
                    <input type="datetime-local" name="tanggal_masuk" style="margin-left:42px;width:20%;display:inline;" class="form-control" required="" placeholder="Klik Disini">
                </div>
                <div class="form-group">
                    <label for="nama_part" style="margin-left: 220px; display: inline;">Nama Part</label>
                    <select class="form-control" name="nama_part" id="nama_part_select" required style="margin-left: 63px; margin-right: 35px; width: 20%; display: inline;">
                ...
                <div class="form-group">
                    ...
                    <input autocomplete="off" type="text" name="nomor_part" id="nomor_part_input" required style="margin-left: 58px; width: 20%; display: inline;" class="form-control" placeholder="Nomor Part" readonly="true">
                </div>
                <!-- Tambahkan input data_part -->
                <input type="hidden" name="data_part" id="data_part" value="">
                <script>
                    ...
                    var dataPartInput = document.getElementById('data_part'); // Input data_part
                    ...
                    nomorPartSelect.addEventListener('change', function() {
                        ...
                        // Set nilai data_part saat perubahan
                        dataPartInput.value = namaPartInput.value;
                    });
                </script>
                <div class="form-group" style="display:inline">
                    <label for="data_stok" style="margin-left:220px;display:inline;">Actual Data Stok</label>
                    <input autocomplete="off" type="number" name="data_stok" required style="margin-left:28px;margin-right:34px;width:20%;display:inline;" class="form-control" id="data_stok" placeholder="Data Stok Part">
                </div>
                ...
                <div class="form-group">
                <label for="id_data_stok" style="margin-left:220px;display:inline;"></label>
                <input autocomplete="off" type="hidden" name="id_data_stok" required style="margin-left:53px;width:20%;display:inline;" class="form-control" readonly="true" value="MWT-<?=date("Ymd");?><?=random_string('numeric', 3);?>">
                </div>
              <!-- /.box-body -->
              
              <div class="box-footer" style="width:89%;">
                <a type="button" class="btn btn-default" style="width:10%;margin-right:26%" onclick="history.back(-1)" name="btn_kembali"><i class="fa fa-arrow-left" aria-hidden="true"></i> Kembali</a>
                <a type="button" class="btn btn-primary" style="width:20%;margin-right:29%" href="<?=base_url('user/tabel_datastok')?>" name="btn_listbarang"><i class="fa fa-table" aria-hidden="true"></i> Lihat Data Stok Part</a>
