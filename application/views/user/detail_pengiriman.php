        ...
        <div class="col-xs-12">
          ...
          <div class="box box-success">
            <div class="box-header">
              <h3 class="box-title"><i class="fa fa-table" aria-hidden="true" style="margin-right:5px"></i>Detail Delivery Part</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <form  method="post" action="<?= base_url('user/cari_pengiriman') ?>" style="display: flex;">
              <a type="button" class="btn btn-default" style="flex: 0; margin-left: 10px; margin-right: 10px; margin-top: 25px;  height:35px;"  href="<?=base_url('user/tabel_datadelv')?>" name="btn_kembali"><i class="fa fa-arrow-left" aria-hidden="true"></i> Kembali</a>
              ...
              <script>
                  document.addEventListener("DOMContentLoaded", function () {
                      ...
                      namaPartSelect.addEventListener("change", function () {
                          ...
                          // Mendapatkan nilai data-nama-part dari opsi yang dipilih
                          var nomorPartValue = selectedOption.getAttribute("data-nama-part");

                          // Mengisi nilai data-nama-part ke dalam input nomor_part
                      ...
                      nomorPoSelect.addEventListener("change", function () {
                          ...
                          // Mendapatkan nilai data-bulan dari opsi yang dipilih
                          var bulanValue = selectedOption.getAttribute("data-bulan");

                          // Mengisi nilai data-bulan ke dalam input bulan
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= $dd->pengiriman ?></td>
                        <td align="center">
                        <a type="button" title="Update" class="btn btn-info"  href="<?=base_url('user/update_datadelv/'.$dd->id_pengiriman)?>" name="btn_update" style="margin-right:10px;"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                        <a type="button" title="Delete" class="btn btn-danger btn-delete"  href="<?=base_url('user/delete_datadelv/'.$dd->id_pengiriman)?>" name="btn_delete" style="margin:1px;margin-left:-5px;"><i class="fa fa-trash" aria-hidden="true"></i></a>
                        <a type="button" title="Tambah" class="btn btn-warning btn-tambah"  href="<?=base_url('user/input_datadelv/'.$dd->id_pengiriman)?>" name="btn_tambah" style="margin:1px; background-color:orange;"><i class="fa fa-plus-square" aria-hidden="true"></i></a>
                    </td>
                    </tr>
                    <?php $no++; ?>
                    <?php endforeach;?>
